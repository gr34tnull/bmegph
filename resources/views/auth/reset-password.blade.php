<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mt-4">
                <x-jet-input id="password_confirmation" class="block w-full mt-1" type="password" placeholder="{{ __('Confirm Password') }}" name="password_confirmation" required autocomplete="new-password" />
            </div>
