...
<div class="flex flex-col items-center justify-center pt-6">
    ...
    <h1 class="pb-5 text-4xl font-extrabold text-center text-white uppercase">NATIONAL ENDORSERS</h1>
    ...
    <div class="grid grid-cols-1 gap-4 mx-20 md:grid-cols-3 lg:xl:grid-cols-4 xl:grid-cols-5">
        ...
        <div class="flex flex-col items-center justify-center p-4 transform bg-gray-100 shadow rounded-xl bg-opacity-80 hover:scale-105">
