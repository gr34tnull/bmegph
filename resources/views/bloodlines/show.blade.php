<x-app-layout>
                                ...
                                @foreach($bloodlines as $bloodline)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="flex-shrink-0 w-10 h-10">
                                            <button type="button" onclick="toggleElement('imageUpload{{$bloodline->id}}')">
                                                <img class="w-10 h-10 rounded-lg" src="{{is_null($bloodline->image) ? asset('placeholder2.png') : asset('/bloodlines/'.$bloodline->image)}}" alt="">
                                            </button>
                                        </div>
                                        <div class="ml-4">
                                    ...
                                    <td class="inline-flex px-6 py-4 text-sm font-medium text-center whitespace-nowrap">
                                        <div class="flex flex-col items-center justify-center mx-2">
                                            <div class="text-sm font-medium text-gray-900">
                                                <button class="pr-2 text-gray-600 hover:text-gray-900 focus:outline-none" onclick="toggleElement('bloodline{{$bloodline->id}}')" ><i class="fas fa-edit"></i></button>
                                            </div>
                                    ...
                                    <!-- Profile Image -->
                                    <div id="imageUpload{{$bloodline->id}}" class="fixed inset-0 z-30 hidden overflow-y-auto">
                                        ...
                                        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                                            ...
                                            <div class="p-6 bg-white">
                                                <div class="flex flex-col">
                                                    <img id="feature" class="w-full h-32 rounded-md lg:h-64" src="{{is_null($bloodline->image) ? 'https://via.placeholder.com/500' : asset('/bloodlines/'.$bloodline->image)}}" />

                                                    <div class="mt-2">
                                                        <x-jet-label for="image" :value="__('Bloodline Image')" />
                                            ...
                                            <div class="px-4 py-2 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                                                ...
                                                <button type="button" class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" onclick="toggleElement('imageUpload{{$bloodline->id}}')">
                                                Close
                                                </button>
                                            </div>
                                            </div>
                                    ...
                                    <!--Modal -->
                                    <div id="bloodline{{$bloodline->id}}" class="fixed inset-0 z-30 hidden overflow-y-auto">
                                        <form method="POST" action="{{route('bloodlines.update',$bloodline->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        @method('patch')
                                        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                                                ...
                                                <div class="border-t border-gray-200">
                                                    ...
                                                    <div class="px-4 py-2 bg-gray-50 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                                        ...
                                                        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                                            <x-jet-input id="name" class="block w-full" type="text" name="name" value="{{$bloodline->name}}" required autofocus />
                                                        </dd>
                                                    </div>
                                            ...
                                            <div class="px-4 py-2 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                                                ...
                                                <button type="button" class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" onclick="toggleElement('bloodline{{$bloodline->id}}')">
                                                Close
                                                </button>
                                            </div>
                                            </div>
    ...
    <button type="button" class="text-gray-600">
        <div class="fixed bottom-0 right-0 z-10 flex items-center justify-center w-12 h-12 mb-10 mr-4 bg-white border rounded-full shadow-md cursor-pointer lg:mr-10">
            <i class="fas fa-plus" onclick="toggleElement('createBloodline')"></i>
        </div>
    </button>
