<x-jet-action-section>
    <x-slot name="title">
        <p class="text-xl font-extrabold text-white">{{ __('Browser Sessions') }}</p>
    </x-slot>

    <x-slot name="description">
        <p class="font-medium text-white text-md">{{ __('Manage and log out your active sessions on other browsers and devices.') }}</p>
    </x-slot>
